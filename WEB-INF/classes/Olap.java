...
public class Olap extends HttpServlet {
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("<div style='float: right'>"
				...
				+ "<input type='submit' name='logout' value='logout'> </form>"
                                +"<form name=help method=get action=menu.jsp><input type=submit name=menu value=menu></form>"
		...
		out.println("<body> <H1>Data Analysis</H1>"
				...
				+ "<input type='checkbox' name='subjectBox' value='1'></input> Subject: <br>"
				...
				+ "<input type='radio' name='order' value='Weekly'></input> Weekly"
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (orderOp != null) {
			...
			if (orderOp.equals("Weekly")) {
				header = "week of";
				select += "extract(day from trunc(timing,'IW'))";
				endGroupBy += "extract(day from trunc(timing,'IW'))";
			}
